...
<body>
		<p class="conTitle">
				<span> 판매 상품</span> <span class="fr"> </span>
		</p>
		<div class="page-wrapper" style="position: relative;">
				<!--page slider -->
				<div class="post-slider">
						<h1 class="silder-title"></h1>
						<select id="productCategory" style="float: left" onchange="fSelectedOptions(this.options[this.selectedIndex].value)"></select>
								...
								<table class="row">
										...
										<tbody>
												<tr>
														...
														<td colspan="2" style="text-align: center;"><img id="tempImg" style="object-fit: cover; max-width: 100%" src="" alt="제품사진미리보기"></td>
												</tr>
												<tr>
														<th scope="row">제조사</th>
												...
												<tr>
														...
														<td colspan="3"><textarea id="pro_det" maxlength="500" name="pro_det" style="height: 130px; outline: none; resize: none;" placeholder="여기에 상세정보를 적어주세요.(500자 이내)"></textarea></td>
												</tr>
										</tbody>
								</table>
								<!-- e : 여기에 내용입력 -->
								<div class="btn_areaC mt30">
										<a href="" class="btnType blue" id="btnInBasket" name="btn"><span>장바구니</span></a> <a class="btnType blue" href="javascript:fAdminBankModal(${null});" name="modal"> <span>주문하기</span></a> <a href="" class="btnType gray" id="btnCloseProductList" name="btn"><span>취소</span></a>
								</div>
						</dd>
				</dl>
