							...
							<div class="selectProject">
								<table width="100%" cellpadding="5" cellspacing="0" border="1" align="left" style="border-collapse: collapse; border: 10px #50bcdf;">
									<tr style="border: 10px; border-color: blue">
										...
										<td width="40" height="25" style="font-size: 100%">지역&nbsp;</td>
										<td><select id="areaall" name="areaall">
										</select></td>
										<td width="30" height="25" style="font-size: 100%"></td>
										<td width="40" height="25" style="font-size: 100%">직무&nbsp;</td>
										<td><select id="joball" name="joball">
										</select></td>
										<td width="30" height="25" style="font-size: 100%"></td>
										<td width="40" height="25" style="font-size: 100%">산업&nbsp;</td>
										<td><select id="industryall" name="industryall">
										</select></td>
										<td width="180" height="25" style="font-size: 120%">&nbsp;&nbsp;</td>
										<td width="100" height="60" style="font-size: 120%"><a href="" class="btnType blue" id="searchBtn" name="btn"><span>검 색</span></a></td>
										<td width="20" height="25" style="font-size: 120%">&nbsp;&nbsp;</td>
									</tr>
								</table>
							</div>
				...
				<dd class="content">
					...
					<table class="row">
						...
						<tbody>
							<tr>
								<th scope="row">제목</th>
								<td colspan="3"><input type="text" class="inputTxt p100" name="grp_cod_eplti" id="inf_title" maxlength="100" readonly /></td>
							</tr>
							<tr>
								<th scope="row">내용</th>
								<td colspan="3"><textarea class="inputTxt p100" style="height: 200px; word-break: break-all;" name="grp_cod_eplti" id="inf_content" readonly></textarea></td>
							</tr>
							<tr>
