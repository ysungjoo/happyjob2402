...
public class UserMenuDto {
	...
	//메뉴 자식 리스트
	private List<UserMenuChildDto> childList = new ArrayList<UserMenuChildDto>();
	...
	public List<UserMenuChildDto> getChildList() {
		return childList;
	}

	public void setChildList(List<UserMenuChildDto> childList) {
