...
<title>Job Korea :: 반품신청 목록 관리</title>
<!-- sweet alert import -->
...
<script type="text/javascript">
	...
	function searchReturn() {
		console.log('search retuen test');
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="Location">
							...
							<span class="btn_nav bold">기준정보</span> <span class="btn_nav bold">반품신청 목록 관리
							</span> <a href="../system/comnCodMgr.do" class="btn_set refresh">새로고침</a>
						</p>

						<p class="conTitle">
							<span>반품신청 목록 관리</span> <span class="fr">
								<button id="insertWarehouse" style="width: 60px; height: 30px;">반품</button>
							</span>
						</p>
						...
						<form action="/scm/searchWarehouse" method="get">
								...
								<fieldset>
									...
									<div id="search">
										<select id="searchKey" name="searchKey">
											<option value="warehouse_name">반품제품명</option>
											<option value="warehouse_address">반품신청날짜</option>
										</select>&nbsp; <input style="width: 300px; height: 25px;" id="sname" name="sname" type="text">
										<button type="submit" style="width: 50px; height: 28px;" onClick="searchReturn">검색</button>
									</div>
								</fieldset>
							</div>
							...
							<div class="divComGrpCodList">
								<table class="col">
									...
									<tbody>
										<c:forEach var="returnList" items="${scmReturnList}">
											<tr>
												<td><a
													href="/scm/detailWarehouse?warehouse_location_code=${warehouse.warehouse_location_code}">${returnList.product_name}</a></td>
												<td>${returnList.return_date}</td>
												<td>${returnList.return_count}</td>
												<td>${returnList.product_madel_price}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
										...
										<tbody>
											<tr>
												...
												<td><input type="text" class="inputTxt p100"
													id="warehouse_location_code" name="warehouse_location_code" /></td>
