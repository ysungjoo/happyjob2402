...
<script type="text/javascript">
  ...
  function fButtonClickEvent() {
    $('a[name=btn]').click(function(e) {
      ...
      switch (btnId) {
      case 'btnSaveUserMgmt':
        fSaveUserMgmt(); // save 안에 저장,수정
        //alert("저장버튼 클릭!!!이벤트!!");
        break;
      case 'btnDeleteUserMgmt':
        fDeleteUserMgmt(); // 만들자 
        //alert("삭제버튼 클릭!!!이벤트!!");		
        break;
      case 'btnClose':
        ...
        break;
      case 'btnUpdateUserMgmt':
        fUpdateUserMgmt(); // 수정하기
        break;
      case 'btnSearchUser':
        fUserMgmtList(); // 검색해서 리스트 뿌리기
        break;
...
<body>
  <form id="myForm" action="" method="">
    ...
    <input type="hidden" id="tmpList" value=""> <input type="hidden" id="tmpListNum" value=""> <input type="hidden" name="action" id="action" value="">
    <!-- 모달 배경 -->
    <div id="mask"></div>
    <div id="wrap_area">
      ...
      <div id="container">
        <ul>
          ...
          <li class="contents">
            ...
            <div class="content">
              <p class="Location">
                <a href="../dashboard/dashboard.do" class="btn_set home">메인으로</a> <span class="btn_nav bold">시스템관리</span> <span class="btn_nav bold">사용자 관리</span> <a href="../system/userMgmt.do" class="btn_set refresh">새로고침</a>
              </p>
              <p class="conTitle">
                <span> 사용자 관리 </span>
              </p>
              <table style="margin-top: 10px" width="100%" cellpadding="5" cellspacing="0" border="1" align="left" style="collapse; border: 1px #50bcdf;">
                <tr style="border: 0px; border-color: blue">
                  ...
                  <td width="50" height="25" style="font-size: 100%; text-align: left; padding-right: 25px;">이 름 &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width: 250px; height: 25px;" id="sname" name="sname"> &nbsp;&nbsp;&nbsp;&nbsp; <select id="searchKey" name="searchKey" style="width: 150px;" v-model="searchKey">
                      <option value="">전체</option>
                      <option value="B">일반회원</option>
                      <option value="C">기업회원</option>
                  </select>
                  </td>
                  <td width="100" height="70" style="font-size: 120%"><a href="" class="btnType blue" id="btnSearchUser" name="btn"><span>검 색</span></a></td>
                </tr>
              </table>
          ...
          <table class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td id="rgcompany_td"><input type="text" class="inputTxt p100" name="user_company" id="user_company" readonly /></td>
              </tr>
              <tr id="birthday1">
              ...
              <tr>
                ...
                <td colspan="3"><input class="inputTxt" style="width: 118px" maxlength="3" type="text" id="tel1" name="user_tel1" readonly /> - <input class="inputTxt" style="width: 118px" maxlength="4" type="text" id="tel2" name="user_tel2" readonly /> - <input class="inputTxt" style="width: 118px" maxlength="4" type="text" id="tel3" name="user_tel3" readonly /></td>
              </tr>
            </tbody>
          </table>
          <!-- 	
